...
\hline
                         & Configurar y ejecutar el algoritmo de RL. &   Política de control robusta entrenada con RL.                          &    El agente mantiene la marcha ante perturbaciones y cambios de velocidad.                                       &     Entrenamiento lento o necesidad de reajustar hiperparámetros.                                \\ \cline{2-2}
\multirow{-2}{=}{HU6}    & Entrenar robustez a irregularidades y cambios de velocidad objetivo. & \multirow{-2}{=}{} & \multirow{-2}{=}{} & \multirow{-2}{=}{} \\
\hline
\end{tabular}
\end{table}
